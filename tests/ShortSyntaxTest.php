...
class ShortSyntaxTest extends TestCase
{
    ...
    {
        $ro = $this->resource->createRequest(Request::GET, 'page://self/index?id=koriym')();
    ...
    {
        $ro = $this->resource->createRequest(Request::GET, 'page://self/index?id=koriym')->__invoke(['id' => 'koriym']);
        $this->assertInstanceOf(Index::class, $ro);
        $this->assertSame('koriym', $ro->body);
    }
    ...
    {
        $index = $this->resource->createRequest(Request::GET, 'page://self/index?id=koriym');
        $ro = $index(['id' => 'koriym']);
    ...
    {
        $ro = $this->resource->createRequest(Request::GET, 'page://self/index')();
        $this->assertInstanceOf(Index::class, $ro);
    }
}
